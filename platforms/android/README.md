...
and `fb.watch` were added later but not yet tested on a real device — update this note once
known. See `PRIVACY.md` for the full note.
...
## Status
Working prototype, released as v0.2.0 (debug-signed APK — see GitHub Releases). Not yet using a
